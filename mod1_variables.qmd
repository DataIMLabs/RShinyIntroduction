...
Wellicht vraag je je af hoe je bij het definieren van het argument `z` kunt verwijzen naar de waarde `y`, terwijl deze waarde nog niet bekend is. Bedenk dat in R geldt dat functieargumenten pas worden geëvalueerd zodra ze binnen de _context_ van de functie worden gebruikt. (lazy-evaluation). 
